...
if (isMobile === false)
{
	$('.mySlides').removeClass("mySlides");
	$('.trending-properties-1').addClass("mySlides");
}

// change bottom review with respect to location
$(document).ready(function() {
	$("#location-1").click(function(){
		document.getElementById('location-r-1').style.display="block";
		document.getElementById('location-r-2').style.display="none";
		document.getElementById('location-r-3').style.display="none";
		document.getElementById('location-r-4').style.display="none";
		document.getElementById('location-r-5').style.display="none";
	});
	$("#location-2").click(function(){
		document.getElementById('location-r-1').style.display="none";
		document.getElementById('location-r-2').style.display="block";
		document.getElementById('location-r-3').style.display="none";
		document.getElementById('location-r-4').style.display="none";
		document.getElementById('location-r-5').style.display="none";
	});
	$("#location-3").click(function(){
		document.getElementById('location-r-1').style.display="none";
		document.getElementById('location-r-2').style.display="none";
		document.getElementById('location-r-3').style.display="block";
		document.getElementById('location-r-4').style.display="none";
		document.getElementById('location-r-5').style.display="none";
	});
	$("#location-4").click(function(){
		...
		document.getElementById('location-r-2').style.display="none";
		document.getElementById('location-r-3').style.display="none";
		document.getElementById('location-r-4').style.display="block";
		document.getElementById('location-r-5').style.display="none";
	});
	$("#location-5").click(function(){
		document.getElementById('location-r-1').style.display="none";
		...
		document.getElementById('location-r-3').style.display="none";
		document.getElementById('location-r-4').style.display="none";
		document.getElementById('location-r-5').style.display="block";
	});
});
